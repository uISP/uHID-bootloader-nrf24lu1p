...
} __attribute_packed__ usb_dev_desc_t;
...
} __attribute_packed__ usb_conf_desc_t;
...
} __attribute_packed__ usb_if_desc_t;
...
} __attribute_packed__ usb_ep_desc_t;
...
typedef struct
{
     ...
     volatile uint8_t d8;
     volatile uint8_t d9;
} __attribute_packed__ usb_hid_desc_t;
